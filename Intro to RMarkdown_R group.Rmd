...
## Let's download knitr (@Anaga - do we really need this or is this and rmarkdown pre-loaded in RStudio?)
...
In-line expressions are written as backtick (\`) r backtick (\`).
...
**Cheat Sheet and Refrence Guide** for R Markdown available with Help \> Cheatsheets
